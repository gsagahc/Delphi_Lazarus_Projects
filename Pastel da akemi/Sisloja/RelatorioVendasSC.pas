...
type
  TFrmPrinPedSCMatric1 = class(TQuickRep)
    DetailBand1: TQRBand;
    ...
    IBQItensNUMERO: TIntegerField;
    IBQItensCODIGO: TIntegerField;
    IBQItensDESCRICAO1: TIBStringField;
    IBQItensCODBARRAS: TIBStringField;
    IBQItensPRECO: TFloatField;
    IBQItensCUSTO: TFloatField;
    IBQItensFORNECEDOR: TIntegerField;
    IBQItensDATACADASTRO: TDateTimeField;
...
var
  FrmPrinPedSCMatric1: TFrmPrinPedSCMatric1;
