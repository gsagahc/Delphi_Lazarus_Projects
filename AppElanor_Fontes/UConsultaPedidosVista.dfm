object FrmConsultarPedVista: TFrmConsultarPedVista
  Left = 361
  Top = 188
  AutoScroll = False
  BorderIcons = []
  Caption = 'Relat'#243'rio de pedidos a vista'
  ClientHeight = 502
  ClientWidth = 920
  Color = clBtnFace
  ...
  object IBQPedidos: TIBQuery
    ...
    SQL.Strings = (
      ...
      'AND TB_PEDIDOS.TBPED_NOME=:pNomeCli '
      'AND TB_PEDIDOS.ID_PRAZO=:pPrazo'
      'AND (TBPED_CANCELADO IS NULL OR TBPED_CANCELADO <>'#39'S'#39')'
    ...
    object IBQPedidosID_PEDIDO: TIntegerField
      FieldName = 'ID_PEDIDO'
      Origin = 'TB_PEDIDOS.ID_PEDIDO'
      Required = True
    end
    object IBQPedidosTBPED_DATA: TDateField
      FieldName = 'TBPED_DATA'
      Origin = 'TB_PEDIDOS.TBPED_DATA'
    end
    object IBQPedidosID_CLIENTE: TIntegerField
      FieldName = 'ID_CLIENTE'
      Origin = 'TB_PEDIDOS.ID_CLIENTE'
    end
    object IBQPedidosTBPED_NOME: TIBStringField
      FieldName = 'TBPED_NOME'
      Origin = 'TB_PEDIDOS.TBPED_NOME'
      Size = 60
    end
    object IBQPedidosTBPED_ENDERECO: TIBStringField
      FieldName = 'TBPED_ENDERECO'
      Origin = 'TB_PEDIDOS.TBPED_ENDERECO'
      Size = 60
    end
    object IBQPedidosTBPED_CIDADE: TIBStringField
      FieldName = 'TBPED_CIDADE'
      Origin = 'TB_PEDIDOS.TBPED_CIDADE'
      Size = 60
    end
    object IBQPedidosTBPED_ESTADO: TIBStringField
      FieldName = 'TBPED_ESTADO'
      Origin = 'TB_PEDIDOS.TBPED_ESTADO'
      FixedChar = True
      Size = 2
    end
    object IBQPedidosTBPED_TELEFONE: TIBStringField
      FieldName = 'TBPED_TELEFONE'
      Origin = 'TB_PEDIDOS.TBPED_TELEFONE'
      Size = 16
    end
    object IBQPedidosID_PRAZO: TIntegerField
      FieldName = 'ID_PRAZO'
      Origin = 'TB_PEDIDOS.ID_PRAZO'
    end
    object IBQPedidosTBPED_VALTOTAL: TIBBCDField
      FieldName = 'TBPED_VALTOTAL'
    ...
    object IBQPedidosTBPED_VENC01: TDateField
      FieldName = 'TBPED_VENC01'
      Origin = 'TB_PEDIDOS.TBPED_VENC01'
    end
    object IBQPedidosTBPED_VENC02: TDateField
      FieldName = 'TBPED_VENC02'
      Origin = 'TB_PEDIDOS.TBPED_VENC02'
    end
    ...
    object IBQPedidosID_USUARIO: TIntegerField
      ...
      Origin = 'TB_PEDIDOS.ID_USUARIO'
    end
    object IBQPedidosTBPED_BAIRRO: TIBStringField
      FieldName = 'TBPED_BAIRRO'
      Origin = 'TB_PEDIDOS.TBPED_BAIRRO'
      Size = 60
    end
    object IBQPedidosTBPED_CNPJ: TIBStringField
      FieldName = 'TBPED_CNPJ'
      Origin = 'TB_PEDIDOS.TBPED_CNPJ'
      Size = 18
    end
    object IBQPedidosTBPRZ_NOME: TIBStringField
      FieldName = 'TBPRZ_NOME'
      Origin = 'TB_PRAZOS.TBPRZ_NOME'
      Size = 30
    end
    object IBQPedidosTBPED_NUMPED: TIBStringField
      FieldName = 'TBPED_NUMPED'
      Origin = 'TB_PEDIDOS.TBPED_NUMPED'
      Size = 10
    end
    object IBQPedidosTBUSR_NOME: TIBStringField
      FieldName = 'TBUSR_NOME'
      Origin = 'TB_USUARIO.TBUSR_NOME'
      Size = 60
    end
    object IBQPedidosTBPED_CANCELADO: TIBStringField
  ...
  object IBQItensPedido: TIBQuery
    Database = FrmPrincipal.IBDMain
    Transaction = FrmPrincipal.IBTMain
    BufferChunks = 1000
    CachedUpdates = False
    ...
    object IBQItensPedidoTBPRD_NOME: TIBStringField
      DisplayLabel = 'Produto'
      FieldName = 'TBPRD_NOME'
      Origin = 'TB_PRODUTOS.TBPRD_NOME'
      Size = 60
    end
    object IBQItensPedidoTBITPED_VALUNI: TIBBCDField
      DisplayLabel = 'Valor unit'#225'rio'
      FieldName = 'TBITPED_VALUNI'
      Origin = 'TB_ITENSPEDIDO.TBITPED_VALUNI'
      DisplayFormat = 'R$ #0.000'
      currency = True
      Precision = 18
      Size = 4
    end
    object IBQItensPedidoTBITPED_VALTOT: TIBBCDField
      DisplayLabel = 'Valor total'
      FieldName = 'TBITPED_VALTOT'
      Origin = 'TB_ITENSPEDIDO.TBITPED_VALTOT'
      DisplayFormat = 'R$ #0.000'
      currency = True
      Precision = 18
      Size = 2
    end
    object IBQItensPedidoTBITPED_UNIDADE: TIBStringField
      DisplayLabel = 'Unidade'
      FieldName = 'TBITPED_UNIDADE'
      Origin = 'TB_ITENSPEDIDO.TBITPED_UNIDADE'
      FixedChar = True
      Size = 3
    end
    object IBQItensPedidoTBITPED_TIPO: TIBStringField
      DisplayLabel = 'Tipo'
      FieldName = 'TBITPED_TIPO'
      Origin = 'TB_ITENSPEDIDO.TBITPED_TIPO'
      FixedChar = True
      Size = 16
    end
    object IBQItensPedidoID_ITENSPEDIDO: TIntegerField
      FieldName = 'ID_ITENSPEDIDO'
      Origin = 'TB_ITENSPEDIDO.ID_ITENSPEDIDO'
      Required = True
      Visible = False
    end
    object IBQItensPedidoTBITPED_QUANT: TIBBCDField
      DisplayLabel = 'Quantidade'
      FieldName = 'TBITPED_QUANT'
      Origin = 'TB_ITENSPEDIDO.TBITPED_QUANT'
      DisplayFormat = '###,###,##0.000'
      Precision = 18
      Size = 2
    end
  ...
  object IBQClientes: TIBQuery
    ...
    CachedUpdates = False
    SQL.Strings = (
      'SELECT DISTINCT TBPED_NOME FROM TB_PEDIDOS'
      'WHERE ID_PRAZO=6'
      'AND (TBPED_CANCELADO IS NULL OR TBPED_CANCELADO <>'#39'S'#39')'
      'ORDER BY TBPED_NOME')
    Left = 160
  ...
  object DDsClientes: TDataSource
    DataSet = IBQClientes
    Left = 160
    Top = 137
  end
