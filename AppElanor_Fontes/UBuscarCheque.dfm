object FrmBuscarCheques: TFrmBuscarCheques
  Left = 267
  Top = 231
  BorderIcons = []
  ...
  object Panel2: TPanel
    ...
    object CheckBoxObs: TCheckBox
      Left = 192
      Top = 144
      Width = 169
      Height = 17
      Caption = 'Procurar no campo OBS'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'MS Sans Serif'
    ...
    object DTPicker: TDateTimePicker
      ...
      Width = 409
      Height = 21
      Date = 43855.275860752310000000
      Time = 43855.275860752310000000
      TabOrder = 5
  ...
  object IBQCheque: TIBQuery
    ...
    object IBQChequeTBCH_NUMPED: TIBStringField
    ...
    object IBQChequeTBCH_OBS: TMemoField
      FieldName = 'TBCH_OBS'
      Origin = 'TB_CHEQUES.TBCH_OBS'
      BlobType = ftMemo
      Size = 8
    end
  end
  ...
  object CDSCheque: TClientDataSet
    ...
    object CDSChequeid_Cheque: TIntegerField
      FieldName = 'id_Cheque'
    end
    object CDSChequePedido: TStringField
      FieldName = 'Pedido'
      Size = 10
    end
    object CDSChequeValor: TCurrencyField
      FieldName = 'Valor'
    end
    object CDSChequeBomPara: TDateField
      FieldName = 'BomPara'
    end
