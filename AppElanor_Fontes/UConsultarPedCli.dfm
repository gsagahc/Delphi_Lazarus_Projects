object FrmConsultarPedCli: TFrmConsultarPedCli
  ...
  object IBQPedidos: TIBQuery
    ...
    SQL.Strings = (
      ...
      'WHERE TB_PEDIDOS.TBPED_NOME=:pNomeCli'
      'AND TBPED_DATA BETWEEN :pDataIni AND :pDataFin'
    ...
    object IBQPedidosTBPED_MOTIVOCANCEL: TIBStringField
      FieldName = 'TBPED_MOTIVOCANCEL'
      Origin = 'TB_PEDIDOS.TBPED_MOTIVOCANCEL'
      Size = 150
    end
  end
