object FrmBuscarLote: TFrmBuscarLote
  Left = 496
  Top = 223
  BorderIcons = []
  ...
  object IBQProdutos: TIBQuery
    ...
    SQL.Strings = (
      ...
      '                  TB_LOTEPEDIDO.TBLTPED_NUMPED'
      'FROM TB_LOTE'
      'INNER JOIN TB_PRODUTOS'
      'ON TB_PRODUTOS.ID_PRODUTO=TB_LOTE.TBL_ID_PRODUTO'
      'INNER JOIN TB_LOTEPEDIDO'
      'ON TB_LOTEPEDIDO.TBLTPED_NUMLOTE= TBL_NUMLOTE'
