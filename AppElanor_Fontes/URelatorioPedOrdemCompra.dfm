object FrmConsultarPedOrdemCompra: TFrmConsultarPedOrdemCompra
  Left = 360
  Top = 195
  AutoScroll = False
  BorderIcons = []
  Caption = 'Consultar pedidos pelo campo observa'#231#227'o'
  ClientHeight = 502
  ClientWidth = 920
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object Label1: TLabel
      ...
      Width = 293
      Height = 13
      Caption = 'Digite o texto no campo observa'#231#227'o (ou parte dele)'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'MS Sans Serif'
  ...
  object Panel2: TPanel
    ...
    object DBGrid1: TDBGrid
      ...
      Hint = 
        ...
        'ixo'
      Ctl3D = False
      DataSource = FrmPrincipal.DsPedidos_OBS
      ParentCtl3D = False
