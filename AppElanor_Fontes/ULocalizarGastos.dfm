object FrmBuscarGastos: TFrmBuscarGastos
  Left = 516
  Top = 339
  BorderIcons = []
  ...
  object Panel2: TPanel
    ...
    object DateTimePicker1: TDateTimePicker
      ...
      BevelInner = bvNone
      BevelOuter = bvNone
      Date = 44021.545034849540000000
      Time = 44021.545034849540000000
      TabOrder = 0
    end
    object CBoxFornecedor: TComboBox
      Left = 24
      Top = 64
      Width = 369
      Height = 21
  ...
  object IBQGastos: TIBQuery
    ...
    Left = 240
    Top = 42
    object IBQGastosTBG_VALOR: TIBBCDField
      FieldName = 'TBG_VALOR'
    ...
    object IBQGastosTBG_DATA: TDateField
      FieldName = 'TBG_DATA'
      Origin = 'TB_GASTOS.TBG_DATA'
    end
    object IBQGastosID_FORNECEDOR: TIntegerField
      FieldName = 'ID_FORNECEDOR'
      Origin = 'TB_GASTOS.ID_FORNECEDOR'
    end
    object IBQGastosTBG_DESCRICAO: TIBStringField
      FieldName = 'TBG_DESCRICAO'
      Origin = 'TB_GASTOS.TBG_DESCRICAO'
      Size = 60
    end
    object IBQGastosTBFOR_NOME: TIBStringField
      FieldName = 'TBFOR_NOME'
      Origin = 'TB_FORNECEDORES.TBFOR_NOME'
      Size = 60
    end
    object IBQGastosID_GASTO: TIntegerField
      FieldName = 'ID_GASTO'
      Origin = 'TB_GASTOS.ID_GASTO'
    end
  end
