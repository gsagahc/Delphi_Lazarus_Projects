object FrmGraficoVenProd: TFrmGraficoVenProd
  Left = 371
  Top = 149
  AutoScroll = False
  BorderIcons = []
  Caption = 'Gr'#225'fico de vendas por produto'
  ClientHeight = 502
  ClientWidth = 924
  Color = clBtnFace
    ...
    object TabSheet1: TTabSheet
      ...
      object Panel5: TPanel
        ...
        object Chart1: TChart
          ...
          Title.Font.Style = [fsBold]
          Title.Text.Strings = (
            'Gr'#225'fico de vendas por produto')
          LeftAxis.Automatic = False
          LeftAxis.AutomaticMinimum = False
          LeftAxis.Title.Caption = 'Quantidade vendida'
          RightAxis.Title.Caption = 'Datas'
          View3D = False
          Align = alClient
          TabOrder = 0
  ...
  object IBQPedidos: TIBQuery
    ...
    SQL.Strings = (
      ...
      'WHERE TB_PEDIDOS.TBPED_DATA BETWEEN :PDataIni AND :PDataFin '
    ...
    object IBQuery1ID_PRODUTO: TIntegerField
      FieldName = 'ID_PRODUTO'
      Origin = 'TB_ITENSPEDIDO.ID_PRODUTO'
    end
    object IBQuery1TBITPED_VALUNI: TIBBCDField
      FieldName = 'TBITPED_VALUNI'
    ...
    object IBQuery1TBITPED_VALTOT: TIBBCDField
      FieldName = 'TBITPED_VALTOT'
    ...
    object IBQuery1ID_PEDIDO: TIntegerField
      FieldName = 'ID_PEDIDO'
      Origin = 'TB_ITENSPEDIDO.ID_PEDIDO'
    end
    object IBQuery1TBITPED_UNIDADE: TIBStringField
      FieldName = 'TBITPED_UNIDADE'
      Origin = 'TB_ITENSPEDIDO.TBITPED_UNIDADE'
      FixedChar = True
      Size = 3
    end
    object IBQuery1TBITPED_TIPO: TIBStringField
      FieldName = 'TBITPED_TIPO'
      Origin = 'TB_ITENSPEDIDO.TBITPED_TIPO'
      FixedChar = True
      Size = 16
    end
    object IBQuery1TBPED_DATA: TDateField
      FieldName = 'TBPED_DATA'
      Origin = 'TB_PEDIDOS.TBPED_DATA'
    end
    object IBQuery1TBPED_NOME: TIBStringField
      FieldName = 'TBPED_NOME'
      Origin = 'TB_PEDIDOS.TBPED_NOME'
      Size = 60
    end
    object IBQuery1TBPED_NUMPED: TIBStringField
      FieldName = 'TBPED_NUMPED'
    ...
    object IBQPedidosTBITPED_QUANT: TIBBCDField
      FieldName = 'TBITPED_QUANT'
  ...
  object CDsGrafico: TClientDataSet
    ...
    Left = 300
    Top = 144
    object CDsGraficoData: TDateField
      FieldName = 'Data'
    end
    object CDsGraficoQuantidade: TIntegerField
