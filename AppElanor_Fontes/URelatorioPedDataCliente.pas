...
type
  TFrmRelatorioPedDataCli = class(TForm)
    Panel1: TPanel;
    Panel2: TPanel;
    DBGrid1: TDBGrid;
...
var
  FrmRelatorioPedDataCli: TFrmRelatorioPedDataCli;
...
procedure TFrmRelatorioPedDataCli.PNGButton2Click(Sender: TObject);
begin
  Close;
end;

procedure TFrmRelatorioPedDataCli.PNGButton1Click(Sender: TObject);
var StrSql:string;
begin
...
procedure TFrmRelatorioPedDataCli.DBGrid1DblClick(Sender: TObject);
begin
...
procedure TFrmRelatorioPedDataCli.PNGButton6Click(Sender: TObject);
begin
...
procedure TFrmRelatorioPedDataCli.DBGrid1CellClick(Column: TColumn);
begin
  Pedido:=TPedido.Create;
  Pedido.Id_pedido:=FrmPrincipal.IBQPedidosID_PEDIDO.AsInteger;
end;

procedure TFrmRelatorioPedDataCli.FormShow(Sender: TObject);
begin
...
procedure TFrmRelatorioPedDataCli.DBGrid1DrawColumnCell(Sender: TObject;
...
procedure TFrmRelatorioPedDataCli.PNGButton8Click(Sender: TObject);
begin
  If FrmPrincipal.IBQPedidos.Active then
    FrmPrincipal.IBQPedidos.First;
end;

procedure TFrmRelatorioPedDataCli.PNGButton7Click(Sender: TObject);
begin
  If FrmPrincipal.IBQPedidos.Active then
