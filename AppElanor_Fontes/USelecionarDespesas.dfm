object FrmSelecionaDespesas: TFrmSelecionaDespesas
  Left = 192
  Top = 107
  Width = 521
  Height = 168
  ...
  object Panel1: TPanel
    ...
    object ComboBoxTipoDespesa: TComboBox
      Left = 240
      Top = 24
      Width = 265
      Height = 22
  ...
  object IBQDespesas: TIBQuery
    ...
    object IBQDespesasID_CADDESPESAS: TIntegerField
      FieldName = 'ID_CADDESPESAS'
      Origin = 'TB_GASTOS.ID_CADDESPESAS'
    end
    object IBQDespesasTBCADDESP_NOME: TIBStringField
      FieldName = 'TBCADDESP_NOME'
      Origin = 'TB_CADDESPESAS.TBCADDESP_NOME'
      Size = 100
    end
  end
  ...
  object IBQUtil: TIBQuery
    ...
    CachedUpdates = False
    SQL.Strings = (
      'SELECT TBCADDESP_NOME,'
      '               ID_CADDESPESAS'
      'FROM    TB_CADDESPESAS'
      '   ')
    Left = 136
    Top = 80
    object IBQUtilTBCADDESP_NOME: TIBStringField
      FieldName = 'TBCADDESP_NOME'
      Origin = 'TB_CADDESPESAS.TBCADDESP_NOME'
      Size = 100
    end
    object IBQUtilID_CADDESPESAS: TIntegerField
      FieldName = 'ID_CADDESPESAS'
      Origin = 'TB_CADDESPESAS.ID_CADDESPESAS'
    end
  end
end
