...
type
  TFrmRelContasPagas = class(TForm)
    QuickRep1: TQuickRep;
    QRBand1: TQRBand;
    QRImage1: TQRImage;
    QRLabel18: TQRLabel;
...
var
  FrmRelContasPagas: TFrmRelContasPagas;
...
procedure TFrmRelContasPagas.GroupFooterBand1BeforePrint(
...
procedure TFrmRelContasPagas.GroupHeaderBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
