object FrmBuscarContaPaga: TFrmBuscarContaPaga
  Left = 451
  Top = 276
  BorderIcons = []
  ...
  object Panel2: TPanel
    ...
    object DateTimePicker1: TDateTimePicker
      ...
      Width = 105
      Height = 21
      Date = 43882.495337928240000000
      Time = 43882.495337928240000000
      TabOrder = 0
    end
    object DateTimePicker2: TDateTimePicker
      ...
      Width = 105
      Height = 21
      Date = 43882.495892233800000000
      Time = 43882.495892233800000000
      TabOrder = 1
    end
  end
  object IBQContaPaga: TIBQuery
    ...
    SQL.Strings = (
      ...
      'WHERE ( TBCONT_STATUS IS NOT NULL AND TBCONT_STATUS='#39'PG'#39')'
      'AND TBCONT_DATAPAG BETWEEN :pDataIni AND :PDataFin')
    Left = 184
    Top = 146
    ParamData = <
      item
    ...
    object IBQContaPagaTBCONT_NUMNOTA: TIBStringField
      FieldName = 'TBCONT_NUMNOTA'
      Origin = 'TB_CONTASPAGAR.TBCONT_NUMNOTA'
      Size = 12
    end
    object IBQContaPagaTBCONT_EMISSAO: TDateField
      FieldName = 'TBCONT_EMISSAO'
      Origin = 'TB_CONTASPAGAR.TBCONT_EMISSAO'
    end
    object IBQContaPagaTBCONT_VALORNOTA: TIBBCDField
      FieldName = 'TBCONT_VALORNOTA'
    ...
    object IBQContaPagaTBCONT_VENCIMENTO: TDateField
      FieldName = 'TBCONT_VENCIMENTO'
      Origin = 'TB_CONTASPAGAR.TBCONT_VENCIMENTO'
    end
    object IBQContaPagaTBCONT_VALOR: TIBBCDField
    ...
    object IBQContaPagaTBFOR_NOME: TIBStringField
      FieldName = 'TBFOR_NOME'
      Origin = 'TB_FORNECEDORES.TBFOR_NOME'
      Size = 60
    end
    object IBQContaPagaTBCONT_DATAPAG: TDateField
      FieldName = 'TBCONT_DATAPAG'
      Origin = 'TB_CONTASPAGAR.TBCONT_DATAPAG'
    end
  end
  object DSFornecedor: TDataSource
    DataSet = IBQContaPaga
    Left = 152
    Top = 147
  end
