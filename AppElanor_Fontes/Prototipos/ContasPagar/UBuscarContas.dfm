object FrmBuscarContas: TFrmBuscarContas
  Left = 516
  Top = 339
  BorderIcons = []
  ...
  object IBQFornecedor: TIBQuery
    ...
    SQL.Strings = (
      ...
      'WHERE ( TBCONT_STATUS IS  NULL OR TBCONT_STATUS<>'#39'PG'#39')'
      'AND TBCONT_NUMNOTA=:pNUMNOTA')
    Left = 216
    Top = 90
    ParamData = <
      item
    ...
    object IBQFornecedorTBCONT_NUMNOTA: TIBStringField
      FieldName = 'TBCONT_NUMNOTA'
      Origin = 'TB_CONTASPAGAR.TBCONT_NUMNOTA'
      Size = 12
    end
    object IBQFornecedorTBCONT_EMISSAO: TDateField
      FieldName = 'TBCONT_EMISSAO'
      Origin = 'TB_CONTASPAGAR.TBCONT_EMISSAO'
    end
    object IBQFornecedorTBCONT_VALORNOTA: TIBBCDField
      FieldName = 'TBCONT_VALORNOTA'
    ...
    object IBQFornecedorTBCONT_VENCIMENTO: TDateField
      FieldName = 'TBCONT_VENCIMENTO'
      Origin = 'TB_CONTASPAGAR.TBCONT_VENCIMENTO'
    end
    object IBQFornecedorTBCONT_VALOR: TIBBCDField
      FieldName = 'TBCONT_VALOR'
    ...
    object IBQFornecedorTBFOR_NOME: TIBStringField
      FieldName = 'TBFOR_NOME'
      Origin = 'TB_FORNECEDORES.TBFOR_NOME'
      Size = 60
    end
    object IBQFornecedorID_CONTASPAGAR: TIntegerField
