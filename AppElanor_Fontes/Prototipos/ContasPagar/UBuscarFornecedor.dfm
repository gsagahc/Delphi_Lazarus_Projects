object FrmBuscarFornecedor: TFrmBuscarFornecedor
  Left = 516
  Top = 339
  BorderIcons = []
  ...
  object Panel1: TPanel
    ...
    object DBGrid1: TDBGrid
      ...
      Columns = <
        ...
        item
          Expanded = False
          FieldName = 'TBFOR_CNPJ'
          Title.Caption = 'CNPJ'
          Visible = True
        end
        item
          Expanded = False
          FieldName = 'TBFOR_BAIRRO'
          Title.Caption = 'Bairro'
          Visible = True
        end
        item
          Expanded = False
          FieldName = 'TBFOR_CIDADE'
  ...
  object IBQFornecedor: TIBQuery
    ...
    object IBQFornecedorTBFOR_CNPJ: TIBStringField
      FieldName = 'TBFOR_CNPJ'
      Origin = 'TB_FORNECEDORES.TBFOR_CNPJ'
    end
    object IBQFornecedorTBFOR_BAIRRO: TIBStringField
      FieldName = 'TBFOR_BAIRRO'
      Origin = 'TB_FORNECEDORES.TBFOR_BAIRRO'
      Size = 60
    end
    object IBQFornecedorTBFOR_CIDADE: TIBStringField
      FieldName = 'TBFOR_CIDADE'
      Origin = 'TB_FORNECEDORES.TBFOR_CIDADE'
      Size = 60
    end
    object IBQFornecedorID_FORNECEDOR: TIntegerField
      FieldName = 'ID_FORNECEDOR'
      Origin = 'TB_FORNECEDORES.ID_FORNECEDOR'
    end
  end
