unit UGraficoEstimadoFaturamento;
...
type
  TFrmGraficoEstimaFaturamento = class(TForm)
    Panel1: TPanel;
    Chart1: TChart;
    Series1: TLineSeries;
    Panel2: TPanel;
...
var
  FrmGraficoEstimaFaturamento: TFrmGraficoEstimaFaturamento;
...
function TFrmGraficoEstimaFaturamento.mtdImprimeGrafico(aGrafico: TChart;
...
procedure TFrmGraficoEstimaFaturamento.PNGButton2Click(Sender: TObject);
begin
  Close;
end;

procedure TFrmGraficoEstimaFaturamento.PNGButton6Click(Sender: TObject);
begin
