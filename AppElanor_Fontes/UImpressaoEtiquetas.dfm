object FrmImpEtiquetas: TFrmImpEtiquetas
  ...
  object CDSEtiqueta: TClientDataSet
    ...
    object CDSEtiquetaPRODUTO: TStringField
      FieldName = 'PRODUTO'
      Size = 60
    end
    object CDSEtiquetaQUANTIDADE: TStringField
      FieldName = 'QUANTIDADE'
      Size = 60
    end
    object CDSEtiquetaPESOL: TStringField
      FieldName = 'PESOL'
      Size = 10
    end
    ...
    object CDSEtiquetaIMAGEM: TGraphicField
      FieldName = 'IMAGEM'
      BlobType = ftGraphic
    end
    object CDSEtiquetaNUMLOTE: TStringField
      DisplayWidth = 20
      FieldName = 'NUMLOTE'
    end
  end
