unit CPF_Edit;
{Componente Edit para aceitar apenas números e realizar validação de CPF
----------------Guilherme Chagas----------------------------------------}
interface
...
begin
    inherited Create(AOwner);
     EditHint:='Favor digitar apenas CPF válido';
     Text := '0';
end;
...
begin
  if Not validaCPF(Text) then
     ShowMessage('Favor digitar um CPF válido');
